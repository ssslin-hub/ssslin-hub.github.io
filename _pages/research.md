...
* Develop a model integrating agent expertise within a network and the private signals received by each agent in iterative processes; analyze the conditions necessary for group consensus
* Investigate the effect of agents who intentionlly give misinformation to the model
...
* Delivered presentations on the research, with slides available [here](https://github.com/user-attachments/files/17964330/Helly_Final_Presentation.6.pdf)
...
* A paper that proposed and proved the minimum packing density among all sets of four integers is \\(\frac{1}{7}\\) , achieved by \\( \\{0,1,4,6\\} \\), can be found [here]([https://github.com/user-attachments/files/18137418/Packing_Paper.pdf](https://www.arxiv.org/abs/2501.01571))
...
properties
* A paper that proposed and proved the threshold of \\(r\\) for the \\(k\\)-collapsibility of a uniformly and randomly
distributed *Vietoris Rips* complex on a \\(d\\)-sphere with \\(n\\) points and distance parameter \\(r\\) can be found 
[here](https://github.com/user-attachments/files/17466427/Collapsibility.pdf)

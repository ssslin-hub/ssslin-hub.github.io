...
* A paper that proposed and proved the packing densities of sets of four integers is \\(\frac{1}{7}\\) , achieved by \\( \\{0,1,4,6\\} \\), can be found [here]([https://github.com/user-attachments/files/18137418/Packing_Paper.pdf](https://www.arxiv.org/abs/2501.01571))

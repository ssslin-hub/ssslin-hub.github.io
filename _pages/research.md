...
* A paper that proposed and proved the minimum packing density among all sets of four integers is \\(\frac{1}{7}\\) , achieved by \\( \\{0,1,4,6\\} \\), can be found [here](https://www.arxiv.org/abs/2501.01571)
